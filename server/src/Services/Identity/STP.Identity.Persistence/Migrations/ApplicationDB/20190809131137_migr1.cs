    ...
    public partial class migr1 : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_aspnetuseravatars", x => x.Id);
                    table.ForeignKey(
                        name: "FK_aspnetuseravatars_AspNetUsers_UserId",
                        column: x => x.UserId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_aspnetuseravatars_UserId",
                table: "aspnetuseravatars",
                column: "UserId",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_aspnetuseravatars_FileName_FileExtension",
                table: "aspnetuseravatars",
                columns: new[] { "FileName", "FileExtension" })
